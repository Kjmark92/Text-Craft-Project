                ...
                fluidRow(
                    box(title = span('Top 10 Word Counts',style="font-size:20px"), 
                        ...
                        #splitLayout(cellWidths = c("30%", "30%","40%"), 
                                    div(style = 'overflow-y: scroll;max-height:225px;display:inline-block;width:100%;text-align: center;',withSpinner(tableOutput("overall_wordcount"))),
                    ...
                    box(title = span('Top 10 TF-IDF scores ',style="font-size:20px"), 
                        ...
                        #splitLayout(cellWidths = c("30%", "30%","40%"), 
                                    ...
                                    div(style = 'overflow-y: scroll;max-height:225px;display:inline-block;width:100%;text-align: center;',withSpinner(tableOutput("overall_tfidf"))),
                                    #div(style = 'overflow-y: scroll;max-height:225px;margin-left: 30px;',withSpinner(tableOutput("overall_suggestion")))), 
                        height = 300,solidHeader = TRUE,width = 4),
                    box(title = span('Suggested Words to Remove',style="font-size:20px"), 
                        ...
                        #splitLayout(cellWidths = c("30%", "30%","40%"), 
                                    #div(style = 'overflow-y: scroll;max-height:225px;margin-left: 30px;',withSpinner(tableOutput("overall_wordcount"))),
                                    #div(style = 'overflow-y: scroll;max-height:225px;margin-left: 30px;',withSpinner(tableOutput("overall_tfidf"))),
                                    div(style = 'overflow-y: scroll;max-height:225px;display:inline-block;width:100%;text-align: center;',withSpinner(tableOutput("overall_suggestion"))), 
                        height = 300,solidHeader = TRUE,width = 4)
...
server <- function(input, output){
  ...
  output$menu<-renderMenu({sidebarMenu(menuItem(text=span('Home',style="font-size:18px"),tabName = 't1', icon= icon("couch")),
                                       ...
                                       menuItem(text= span('Contact Info',style="font-size:18px"),tabName = "t5", icon= icon("desktop")) ) })   
